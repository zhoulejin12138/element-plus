...
import { spyOn, beforeEach, afterEach } from 'vitest'
...
export function mockImageEvent() {
  const fn = spyOn(window.Image.prototype, 'src', 'set')
  beforeEach(() => {
    fn.mockImplementation(function (this: HTMLImageElement, src: string) {
